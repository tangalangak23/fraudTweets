    ...
    app.post('/newSearch',isLoggedIn, function(req, res) {
      if(!(req.body.term.includes("@")||req.body.term.includes("#"))){
        ...
        MongoClient.connect(url,function(err,db){
          ...
          stats.insert({"name":req.body.name,"count":0,"negativeCount":0,"averageScore":0,"averageNegativeScore":0,"validRepliesFound":0,"fraudulentRepliesFound":0,"validResponseTime":"","invalidResponseTime":""})
          db.close();
